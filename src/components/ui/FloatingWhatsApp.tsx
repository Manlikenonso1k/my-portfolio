export function FloatingWhatsApp() {
  const socials = [
    {
      label: "Instagram",
      href: "https://www.instagram.com/codebynonso/",
    ...
    {
      label: "GitHub",
      href: "https://github.com/Manlikenonso1k",
      bg: "bg-[#171515]",
      size: 56,
      icon: (
        <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
      {socials.map(({ label, href, bg, size, icon }) => (
        <a
          key={label}
          href={href}
          target="_blank"
          ...
          className={`${bg} text-white rounded-full shadow-lg flex items-center justify-center hover:scale-110 active:scale-95 transition-transform duration-300`}
        >
          {icon}
        </a>
      ))}
